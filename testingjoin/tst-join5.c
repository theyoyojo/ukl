...
{
#ifdef WAIT_IN_CHILD
  if (pthread_barrier_init (&b5, NULL, 2) != 0)
    {
  ...
  if (pthread_create (&th, NULL, tf5a, (void *) pthread_self ()) != 0)
    {
  ...
  if (pthread_create (&th, NULL, tf5b, (void *) pthread_self ()) != 0)
    {
