...
{
#ifdef WAIT_IN_CHILD
  if (pthread_barrier_init (&b6, NULL, 2) != 0)
    {
  ...
  if (pthread_create (&th, NULL, tf6a, (void *) pthread_self ()) != 0)
    {
  ...
  if (pthread_create (&th, NULL, tf6b, (void *) pthread_self ()) != 0)
    {
