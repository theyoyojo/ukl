...
static pthread_barrier_t b18;


/* Cleanup handling test.  */
static int cl_called18;
...
tf18 (void *arg)
{
  int r = pthread_barrier_wait (&b18);
  ...
  pthread_cleanup_push (cl18, NULL);
...
do_test18 (void)
{
  if (pthread_barrier_init (&b18, NULL, 2) != 0)
    {
  ...
  pthread_t th;
  if (pthread_create (&th, NULL, tf18, NULL) != 0)
    {
