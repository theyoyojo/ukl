...
static pthread_barrier_t b17;


/* Cleanup handling test.  */
static int cl_called17;
...
tf17a (void *arg)
{
  int r = pthread_barrier_wait (&b17);
  if (r != 0 && r != PTHREAD_BARRIER_SERIAL_THREAD)
    {
      puts ("tf17a: barrier_wait failed");
      exit (1);
    }

  pthread_cleanup_push (cl17, NULL);
  ...
  puts ("tf17a: aio_suspend returned");
...
tf17b (void *arg)
{
  ...
  if (r != 0 && r != PTHREAD_BARRIER_SERIAL_THREAD)
    {
      puts ("tf17b: barrier_wait failed");
      exit (1);
    }
  ...
  puts ("tf17b: aio_suspend returned");
...
do_test17 (void)
{
  ...
  if (pthread_barrier_init (&b17, NULL, 2) != 0)
    {
  ...
  pthread_t th;
  if (pthread_create (&th, NULL, tf17a, &a) != 0)
    {
  ...
  puts ("going to cancel tf17a in-time");
  ...
  if (cl_called17 == 0)
    {
      puts ("tf17a cleanup handler not called");
      return 1;
    }
  if (cl_called17 > 1)
    {
      puts ("tf17a cleanup handler called more than once");
      return 1;
    }

  cl_called17 = 0;

  if (pthread_create (&th, NULL, tf17b, &a) != 0)
    {
      puts ("2nd create failed");
      return 1;
    }

  r = pthread_barrier_wait (&b17);
  if (r != 0 && r != PTHREAD_BARRIER_SERIAL_THREAD)
    {
  ...
  puts ("going to cancel tf17b in-time");
  if (pthread_cancel (th) != 0)
    {
  ...
  if (cl_called17 == 0)
    {
      puts ("tf17b cleanup handler not called");
      return 1;
    }
  if (cl_called17 > 1)
    {
      puts ("tf17b cleanup handler called more than once");
      return 1;
    }
  ...
  if (pthread_create (&th, NULL, tf17a, ap) != 0)
    {
      puts ("3rd create failed");
      return 1;
    }

  puts ("going to cancel tf17a early");
  if (pthread_cancel (th) != 0)
    {
  ...
  if (pthread_create (&th, NULL, tf17b, ap) != 0)
    {
      puts ("4th create failed");
      return 1;
    }

  puts ("going to cancel tf17b early");
  if (pthread_cancel (th) != 0)
    {
