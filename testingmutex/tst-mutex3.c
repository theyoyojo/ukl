...
do_test3 (void)
{
  ...
  if (pthread_barrier_init (&b3, NULL, 2) != 0)
    {
  ...
  pthread_t th;
  if (pthread_create (&th, NULL, tf3, NULL) != 0)
    {
      puts ("create failed");
      return 1;
    }
  ...
  if (pthread_barrier_destroy (&b3) != 0)
    {
